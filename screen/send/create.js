      ...
      <>
        <View>
          ...
          <Text style={styles.transactionDetailsSubtitle}>
            {currency.satoshiToBTC(item.value)} {BitcoinUnit.BID}
          </Text>
          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
            <ScrollView>
              <BlueCard style={styles.card}>
                ...
                <TouchableOpacity style={styles.actionTouch} onPress={() => Linking.openURL('https://wallet.blockidcoin.network/?verify=' + this.state.tx)}>
              ...
              <BlueCard>
                ...
                <Text style={styles.transactionDetailsSubtitle}>
                  {this.state.fee} {BitcoinUnit.BID}
                </Text>
