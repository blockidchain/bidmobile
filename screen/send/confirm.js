  ...
  send() {
    this.setState({ isLoading: true }, async () => {
      try {
        ...
        amount = formatBalanceWithoutSuffix(amount, BitcoinUnit.BID, false);
    ...
    return (
      <>
        <View style={styles.valueWrap}>
          ...
          <Text style={styles.valueUnit}>{' ' + loc.units[BitcoinUnit.BID]}</Text>
        </View>
            ...
            <View style={styles.cardContainer}>
              <BlueCard>
                <Text style={styles.cardText}>
                  {loc.send.create_fee}: {formatBalance(this.state.feeSatoshi, BitcoinUnit.BID)} (
