...
const About = () => {
  ...
  const handleOnGithubPress = () => {
    Linking.openURL('https://github.com/blockidchain/blockidcoin-mobile-wallet');
  };
  const handleOnRatePress = () => {
    const options = {
      AppleAppID: '1376878040',
      GooglePackageName: 'network.blockidcoin.wallet',
      preferredAndroidMarket: AndroidMarket.Google,
      preferInApp: true,
      openAppStoreIfInAppFails: true,
      fallbackPlatformURL: 'https://blockidcoin.network',
    };
