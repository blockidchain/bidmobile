...
const LightningSettings = () => {
  ...
  const setLndhubURI = value => {
    if (DeeplinkSchemaMatch.getUrlFromSetLndhubUrlAction(value)) {
      // in case user scans a QR with a deeplink like `bidwallet:setlndhuburl?url=https%3A%2F%2Flndhub.herokuapp.com`
  ...
  return (
    <SafeBlueArea forceInset={{ horizontal: 'always' }} style={styles.root}>
      ...
      <Button
        ...
        onPress={() => Linking.openURL('https://github.com/BidWallet/LndHub')}
        titleStyle={{ color: colors.buttonAlternativeTextColor }}
        title="github.com/BidWallet/LndHub"
