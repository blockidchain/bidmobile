...
export default class Browser extends Component {
  constructor(props) {
    ...
    this.state = {
      url: url || 'https://www.blockidcoin.network/Exchanges.wiki.en.html/',
      fromWallet: props.route.params.fromWallet,
      canGoBack: false,
      pageIsLoading: false,
      stateURL: url || 'https://www.blockidcoin.network/Exchanges.wiki.en.html/',
    };
          ...
          <View style={styles.safeURLHome}>
            {Platform.OS !== 'ios' && ( // on iOS lappbrowser opens blank page, thus, no HOME button
              <TouchableOpacity
                onPress={() => {
                  processedInvoices = {};
                  this.setState({ url: 'https://blockidcoin.network/marketplace/' });
                }}
              >
                <Ionicons
                  name="ios-home"
