...
export class AbstractWallet {
  ...
  constructor() {
    ...
    this.preferredBalanceUnit = BitcoinUnit.BID;
  ...
  setSecret(newSecret) {
    this.secret = newSecret.trim().replace('blockidcoin:', '').replace('BLOCKIDCOIN:', '');

    if (this.secret.startsWith('blockidcoin1')) this.secret = this.secret.toLowerCase();
