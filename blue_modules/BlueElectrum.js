...
const defaultPeer = { host: 'electrum.blockidcoin.network', tcp: '50001' };
const hardcodedPeers = [
  ...
  // { host: 'preperfect.eleCTruMioUS.com', tcp: '50001' }, // down
   { host: 'electrum.blockidcoin.network', tcp: '50001' },
  // { host: 'electrum1.blockidcoin.network', ssl: '443' }, // 2x weight
  // { host: 'electrum2.blockidcoin.network', ssl: '443' },
  // { host: 'electrum3.blockidcoin.network', ssl: '443' },
  // { host: 'electrum3.blockidcoin.network', ssl: '443' }, // 2x weight
];
...
async function connectMain() {
  ...
  try {
    await DefaultPreference.setName('group.network.blockidcoin.wallet');
  ...
  try {
    ...
    const ver = await mainClient.initElectrum({ client: 'bidwallet', version: '1.4' });
    if (ver && ver[0]) {
