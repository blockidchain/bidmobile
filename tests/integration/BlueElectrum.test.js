...
describe('BlueElectrum', () => {
  it('ElectrumClient can test connection', async () => {
    assert.ok(!(await BlueElectrum.testConnection('electrum1.blockidcoin.network', 444, false)));
    assert.ok(!(await BlueElectrum.testConnection('electrum1.blockidcoin.network', false, 444)));
    ...
    assert.ok(await BlueElectrum.testConnection('electrum1.blockidcoin.network', '50001'));
    assert.ok(await BlueElectrum.testConnection('electrum1.blockidcoin.network', false, 443));
  });
