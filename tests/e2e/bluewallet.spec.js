...
describe('BidWallet UI Tests', () => {
  ...
  it('can import BIP84 mnemonic, fetch balance & transactions, then create a transaction', async () => {
    ...
    await helperImportWallet(process.env.HD_MNEMONIC_BIP84, 'Imported HD SegWit (BIP84 Bech32 Native)', '0.00105526 BID');
    ...
    const bip21 = 'bitcoin:bc1qnapskphjnwzw2w3dk4anpxntunc77v6qrua0f7?amount=0.00015&pj=https://btc.donate.kukks.org/BID/pj';
    ...
    await element(by.id('changeAmountUnitButton')).tap(); // switched to BID
